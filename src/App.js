    ...
    const App = () => {
        ...
        useEffect(() => {
            const currentDayData = weeklyData[selectedDate] || {
                employeeName: '', // These will be overwritten by persistent header data below
                truckNumber: '', // These will be overwritten by persistent header data below
            ...
            // This ensures they don't reset when switching days
            ...
            setReportError('');
        }, [selectedDate, weeklyData]); // Removed employeeName, truckNumber from deps to prevent loop
